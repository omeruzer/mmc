...
use App\Http\Controllers\front\ViberController;
use App\Http\Controllers\front\vibersController;
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'product'], function () {
            ...
            Route::get('/telegram/{id}', [AdminTelegramController::class, 'index'])->name('telegram');
        });
